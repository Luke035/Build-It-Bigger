 ...
 * on 2016-04-02 at 16:33:03 UTC 
 * Modify at your own risk.
 */

package com.example.lucagrazioli.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://joke-project-1269.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.lucagrazioli.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.lucagrazioli.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.lucagrazioli.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.lucagrazioli.myapplication.backend.myApi.model.MyBean.class);
